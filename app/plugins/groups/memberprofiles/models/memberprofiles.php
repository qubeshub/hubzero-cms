...
namespace Plugins\Groups\Memberprofiles\Models;
 ...
 */
class Memberprofiles extends Relational
{
	/**
	 * The table namespace
	 *
	 * @var  string
	 */
	protected $namespace = 'xgroups_profiles';
	 ...
	 * @var  string
	 */
	protected $table = '#__xgroups_profiles';
