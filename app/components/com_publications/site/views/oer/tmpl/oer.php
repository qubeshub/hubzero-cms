...
<?php } ?>
      ...
      <div class="oer-wrapper">
        ...
        <div class="oer-on-qubes">
            ...
            <ul>
              <li>With 1000 user submitted educational resources, the QUBES platform hosts diverse materials that can be adapted to fit your classroom. </li>
              <li>New resources are added regularly and cover many topics in biology, mathematics, and data science.</li>
              <li>The platform also hosts <a href="https://qubeshub.org/qubesresources/software">open source software tools</a>.</li>
        ...
        <div class="share-your-oer">
          ...
          <p>BioQUEST believes in providing quality resources to improve life sciences education with a focus on equity and inclusion in the classroom. We believe in harnessing the power of community to not only create and incubate ideas, but improve or provide feedback which in turn, improves resources for all educators.</p>
          ...
          <div class="contribute-descriptor">
            ...
            <div>
              ...
              <ul>
                <li><strong>Digital Object Identifier (DOI)</strong>: The QUBES Resource Library automatically assigns a DOI to all submitted resources. This DOI provides a stable address that can be used to find your resources and track how it is being used.</li>
          ...
          <div class="contribute-descriptor">
            ...
            <p><a href="https://qubeshub.org/community/partners">Many educational projects and professional societies</a> use QUBES to further broaden the impacts of their work. The BioQUEST <a href="https://qubeshub.org/community/fmns">Faculty Mentoring Networks</a> (FMNs) provide partners with an opportunity to share and improve their materials with faculty who implement these resources in their classrooms - providing valuable real-time feedback. When you share on QUBES, you are also searchable in the <a href="https://mason.deepwebaccess.com/mason__MasonLibrariesOpenEducationResources_5f4/desktop/en/search.html">Mason Open Metafinder</a> database.</p>
          </div>
        </div>
      </div>
