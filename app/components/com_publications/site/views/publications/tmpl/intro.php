...
<div class="page-header">
  ...
  <nav class="nav-page">
    <ul>
      <li><a class="nav-page-link browse-link" href="<?php echo Route::url('index.php?option=' . $this->option . '&task=browse'); ?>">Browse Resources</a> <span class="nav-descriptor">Browse Resources</span></li>
      ...
      <li><a class="nav-page-link submit-link" href="<?php echo Route::url('index.php?option=' . $this->option . '&task=submit'); ?>">Submit a Resource</a> <span class="nav-descriptor">Submit a Resource</span></li>
    </ul>
  </nav>
